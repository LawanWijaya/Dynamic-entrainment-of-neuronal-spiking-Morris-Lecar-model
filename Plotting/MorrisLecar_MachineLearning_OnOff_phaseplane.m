...
% Amp=50; % No square pulse if Amp=0
Amp=20; % No square pulse because Amp=0
L=30;
per=2*L;
php=0.5;
...
pulse_starts = [20,103.71]; % Amp=20, L=20. t0=20
...
% legend('V-nullcline (Forcing off)','V-nullcline (Forcing on)','n-nullcline')
% legend('V-nullcline','n-nullcline')
