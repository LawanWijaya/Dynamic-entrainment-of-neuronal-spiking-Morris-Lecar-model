% We give the pulse onset found by dynamic entrainment in the pulse_start array
% Plot the time series diagram and the phaseplane after dynamic entrainment
% is applied
...
% pulse_starts = [20,103.71, 187.47, 271.09, 354.83, 438.45]; % starting time of each pulse
...
initial_values=[-24.3681,0.1207]; % selected by solving the Morris-Lecar model for the first pulse
